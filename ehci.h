...
#define	ehci_readl_(x)		(*((volatile u32 *)(x)))
#define ehci_writel_(a, b)	(*((volatile u32 *)(a)) = ((volatile u32)b))
#else
#define ehci_readl_(x)		cpu_to_le32((*((volatile u32 *)(x))))
#define ehci_writel_(a, b)	(*((volatile u32 *)(a)) = \
